...
HdCyclesRenderParam::_UpdateSessionFromConfig(bool a_forceInit)
{
    ...
    m_sessionParams.tile_size.x = 64;
    m_sessionParams.tile_size.y = 64;

    if (m_useTiledRendering) {
        m_sessionParams.background = true;
        //m_sessionParams.samples   = 8;
        m_sessionParams.start_resolution   = INT_MAX;
        m_sessionParams.progressive        = false;
        m_sessionParams.progressive_refine = false;
        m_sessionParams.tile_order         = ccl::TILE_HILBERT_SPIRAL;
        //m_sessionParams.bvh_type         = ccl::SceneParams::BVH_STATIC;
    }
